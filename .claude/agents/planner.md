...
- Disciplines (see `docs/FIT-METHODOLOGY.md` — the single source of truth for formulas): road, tt_triathlon, mtb_xc, gravel, cyclocross, touring, kids. Each has its own saddle height adjustments and target torso angle.
